...
class PopularStudyWidget extends StatefulWidget {
  const PopularStudyWidget({super.key});

  @override
  State<PopularStudyWidget> createState() => _PopularStudyWidgetState();
}

class _PopularStudyWidgetState extends State<PopularStudyWidget> {
